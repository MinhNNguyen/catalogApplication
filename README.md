...
9. Install git ```sudo apt-get install git```<br />
...
https://www.digitalocean.com/community/tutorials/how-to-add-and-delete-users-on-an-ubuntu-14-04-vps <br />
https://www.digitalocean.com/community/tutorials/how-to-tune-your-ssh-daemon-configuration-on-a-linux-vps <br />
https://serverfault.com/questions/265410/ubuntu-server-message-says-packages-can-be-updated-but-apt-get-does-not-update <br />
https://httpd.apache.org/docs/2.4/vhosts/name-based.html <br />
http://manpages.ubuntu.com/manpages/xenial/en/man5/sshd_config.5.html <br />
